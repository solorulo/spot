...
DATABASES = {
    'default': {
        ...
        'NAME': 'd1s1h1hssf14l6',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'bsyvtmyudgrzsm',
        'PASSWORD': 'E59iP95KTelk6-3HckB_zjlVeP',
        'HOST': 'ec2-23-21-130-168.compute-1.amazonaws.com',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
